...
const CVDSlopeChart = ({ data }) => {
  ...
  return (
    <div className="w-full" style={{ height: '128px' }}>
      ...
      <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6 pb-32">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 font-mono mt-0.5">
                      ...
                      {mtfStatus?.state_machine?.state?.toUpperCase() || 'OFFLINE'}
                    </p>
                  </div>
                </div>
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div className="w-full h-32 rounded-xl border border-cyan-900/30 bg-gradient-to-b from-cyan-950/20 to-gray-950/40 overflow-hidden">
