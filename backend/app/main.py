...
from .routers import backtest, data, health, live, scalp_card, signals, stream, swings, mtf, kpis
...
app.include_router(mtf.router, prefix="/api/mtf", tags=["multi-timeframe"])